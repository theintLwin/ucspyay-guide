        ...
        <div class="row">
            ...
            <div class="mt-3">
                ...
                <table class="table table-primary table-striped"  >
                    ...
                    @foreach ($courses as $course)
                        <tr >
                            ...
                            <td style="width:25%;height:25%;"><img src="{{ asset('storage/'.$course->Photo) }}" alt="" class="w-50">
                            </td>

                            <td>
                                <a href="{{ route('admin#subject', [$course->CourseName]) }}" >
                                    <button class="btn btn-dark"><i class="fa-solid fa-eye me-3"></i>view subject</button>
                                </a>
                            </td>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin#deleteCourse', [$course->id]) }}">
                ...
                <div style="margin-bottom:200px;">
                    <p class="text-muted text-center mt-3" >There is no course added yet! </p>
                ...
                <div class="modal fade" id="editForm" tabindex="-1" data-bs-backdrop="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal" style="background-color: red;">Close</button>
