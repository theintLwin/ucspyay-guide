...
@section('myContent')
    <div class="insertform">
        <div class="container">
            ...
            <div class="row">
                <div class="col-8 offset-2 shadow rounded-1 mt-4" style="background-color: #a1d0e3">
                    <form class="m-3 p-3 " action="{{ route('admin#teacher#add') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="text-center">
                            <h2>Teacher Insert Form</h2>
                        </div>
                        <label for="position" class=" form-label">Position</label>
                        <select class="form-select" aria-label="Default select example" name="courseName">
                            <option>Open this select menu</option>
                            @foreach ($cnames as $cname)
                                <option @if (old('courseName') == $cname->CourseName) selected @endif>{{ $cname->CourseName }}</option>
                            @endforeach
                        </select>
                        @error('courseName')
                        ...
                        <select class="form-select"  name="subjectName">
                            ...
                            @foreach ($snames as $sname)
                                <option @if (old('subjectName') == $sname->subjectName) selected @endif >
                        ...
                        <label for="position" class="mt-3 form-label">Salary(Kyats)</label>
                        ...
                        <label for="address" class="col-sm-2 col-form-label">Address</label>
                            ...
                            <textarea cols="30" rows="5" class="form-control mb-3 @error('address') is-invalid  @enderror" id="address" name="address" >{{ old('address') }}</textarea>
                        @error('address')
                            <div class="invalid-feedback mb-3">
                                {{ $message }}
                            </div>
                        ...
                        <label for="time" class="col-sm-12 col-form-label">Your available hour <br>
                            <spam style="color:red;">   Select <b>Four</b>  times per course. *From Grade-1 To Grade-9.*</span>
                                <spam style="color:red;">Select <b>Two</b> times per subject. *From Grade-10 To Grade-12.*</span>
                            <spam style="color:red;">Select <b>Three </b>times per course. (Computer BASIC/Programming/Languages)
                            </spam><br>
                        ...
                        <div class=" mt-5 text-center">
                            ...
                            <button type="submit" class="btn btn-dark rounded-pill w-25" name="sendBtn"> + ADD</button>
                        </div>
                    </form>
                </div>
            </div>
